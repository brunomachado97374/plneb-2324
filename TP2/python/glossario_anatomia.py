...
filename = "./xml/anatomia geral.xml"
...
resultado=open("./texts/glossario_anatomia_inicial.txt", "w", encoding='UTF-8')
...
out = open ("./json/termos_anatomia.json", "w", encoding="utf-8")
