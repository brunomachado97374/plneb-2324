...
json1 = './json/conceitos.json'
json2 = './json/termos_glossario.json'
json3 = './json/termos_anatomia.json'
json4 = './json/wipo_modificado.json'
json5 = './json/doencas_site.json'
...
file_out = open("./json/glossario_geral.json","w",encoding= 'utf-8')
