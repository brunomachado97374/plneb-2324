...
filename = "./xml/GlossaÌ_rio de Termos MeÌ_dicos TeÌ_cnicos e Populares.xml"
...
resultado=open("./texts/glossario_inicial.txt", "w", encoding='UTF-8')
...
result=open("./texts/glossario.txt", "w", encoding='UTF-8')
result.write(texto2)
result.close()
...
out = open ("./json/termos_glossario.json", "w", encoding="utf-8")
