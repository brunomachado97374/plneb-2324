...
file = "./json/glossario_geral.json"
...
def listar_doencas():
    ...
    doencas = carregar_conceitos("./json/glossario_geral.json")
...
def listar_categorias():
    caminho_json = "./json/glossario_geral.json"
...
def editar_conceitos(designacao):
    ...
    if request.method == "GET": # É importante existir para quando a página é aberta pela primeira vez aparecerem os dados expostos
        ...
        lista_categorias = obter_categorias("./json/glossario_geral.json")
        ...
        guardar_conceitos(doencas,"./json/glossario_geral.json")
        
        if "glossario_backup.json" in os.listdir("./json"): #guarda também no backup se ele existir, o backup está sempre atualizado
            guardar_conceitos(doencas, "./json/glossario_backup.json")
...
def eliminar_conceito(designacao):
    ...
    if designacao in doencas:
        ...
        shutil.copyfile(caminho_json, "./json/glossario_backup.json")
